...
<body>
	...
	<form action="/updateMaterial" method="POST" enctype="multipart/form-data">
		...
		<tr>
			<th>Material Name : </th>
			<td><input type="text" name="material_name" value="{{$data->name}}"></td>
		</tr>
		
		<tr>
			<th>File to Upload</th>
			<td><input type="file" name="material" required/></td>
		</tr>
		<tr>
